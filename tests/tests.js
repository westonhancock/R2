...
sink('background', function (test, ok, before, after, assert) {
  test('should swap background', function (done) {
    ...
    assert.equal(swap('p{background:color url(../left/right/test_left.png) repeat 20% 20%;}'), 'p{background:color url(../left/right/test_left.png) repeat 80% 20%;}', 'background:color url(../left/right/test_left.png) repeat 20% 20% => color url(../left/right/test_left.png) repeat 80% 20%')
    done()
  })
})
